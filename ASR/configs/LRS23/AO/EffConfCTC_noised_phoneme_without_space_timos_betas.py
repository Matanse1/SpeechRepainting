...
saving_period_step = 1000
# callback_path = "/dsi/gannot-lab/gannot-lab1/users/sellama/phoneme_classifier" # where to save logs and model checkpoints
callback_path = "/home/dsi/sellama/outputs/phoneme_classifier/phoneme_guidance_EffConfCTC_without-space__beta_min_0.01_beta_max_0.5" # where to save logs and model checkpoints
...
sde = VPSDE(beta_min=0.01, beta_max=0.5,  N=1000, sampler_type = "pc")
model.sde = sde
