...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_optimizer", action="store_true", help="Load optimizer and model step from checkpoint")
    ...
    if isinstance(args.checkpoint, str) and args.checkpoint.lower() in ["", "none"]:
