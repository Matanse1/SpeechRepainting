...
def get_models(dataset, type_input_guidance='text', with_space=False):
    ...
    if type_input_guidance == 'text':
        ...
        ngram_path = "/dsi/gannot-lab/gannot-lab1/users/mordehay/asr_yochai_lipvoicer/6gram_lrs23.arpa" # this is the language model
        neural_config_path = "ASR/configs/LRS23/LM/GPT-Small-demo.py" # this is the acoustic model
        neural_checkpoint = "/dsi/gannot-lab/gannot-lab1/users/mordehay/asr_yochai_lipvoicer/checkpoints_epoch_10_step_2860.ckpt" # this is the acoustic model's weights
