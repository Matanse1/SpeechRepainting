...
def main(csv_name='all', interval_save=5, max_workers=4, gpu_dict_var = {0: 4, 1:1}):
    ...
    titles = ['sample_path', 'masked_utmos']
    titles = titles + [met + '_' + voc for met in ['mcd', 'masked_mcd', 'masked_logf0rmse', 'logf0rmse', \
                                                   'speech_bleu', 'masked_speech_bleu',\
                                                       'speech_token_distance', 'masked_speech_token_distance',\
                                                       'speech_bert', 'masked_speech_bert', 'utmos', 'utmos_init'] for voc in vocoder_names]
