...
if __name__=="__main__":
    ...
    #dir='/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+T60+'/res_MP_new/wavs_long_FactoryNoise/'
    # dir='/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+T60+'/res_CoG_babble_noise/'
    dir = '/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+ T60 +'/data_for_VAE/wavs_clean2clean_fine_tuned_BN3'
    parser.add_argument('-t', "--testset_dir", default=dir, 
                        help='Path to the dir containing audio clips in .wav to be evaluated')
    ## create dir to save the csv
    #path ='/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+T60+'/res_FactoryNoise/csv/'
    path = '/dsi/gannot-lab2/datasets2/mirage_daniel/data_set_mirage/'+ T60 +'/data_for_VAE/csvs/csv_clean2clean_fine_tuned_BN3/'
    if not os.path.exists(path):
        os.makedirs(path)
    parser.add_argument('-o', "--csv_path", default=path + T60 + 'DNSMOS.csv', help='Dir to the csv that saves the results')
